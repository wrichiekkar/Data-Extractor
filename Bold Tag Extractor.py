...
if(__name__ == "__main__"):
    # Read links
    data = read_from_txt("Btext_Sites.txt")

    # Test
    # data = 'https://my2.siteimprove.com/Inspector/624660/Accessibility/Page?pageId=23655265134&impmd=6508FEDFC411F126AA9F07EE75D47280#/Criterion/1.3.1/Check/30'
    # get_images(data)
